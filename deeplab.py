...
class DeeplabV3(object):
    _defaults = {
        ...
        # -------------------------------------------------------------------#
        "model_path": r'G:\model_code\Deeplabv3+\deeplabv3-plus.HybridASPP\logs\loss_2026_05_11_16_20_31_MobileNEtV2_HybeidASPP_Axial_Grid\best_epoch_weights.pth',
        # ----------------------------------------#
        #   所需要区分的类的个数+1
        # ----------------------------------------#
        "num_classes": 2,
